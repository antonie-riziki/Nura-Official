...
export function HistoryItem({
  ...
  return (
    <article className="nura-panel flex items-start gap-3 rounded-[1.6rem] p-4">
      ...
      <button
        type="button"
        onClick={onDelete}
        className="inline-flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-white/5"
